...
// convex/leagues.ts's createLeague (league cap), convex/draft/reportCard.ts
// (Report Card, and by extension the AI recap it triggers - see convex/
// gemini/reportSummary.ts), and convex/draftValues.ts (real vs. generic $
